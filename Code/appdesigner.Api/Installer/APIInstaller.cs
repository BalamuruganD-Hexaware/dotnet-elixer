...
using ElmahCore.Mvc;
using ElmahCore;
using appdesigner.Api.Filters;
using appdesigner.Business.Installer;

namespace appdesigner.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "appdesigner API", Version = version + "-" + branch});
            });
